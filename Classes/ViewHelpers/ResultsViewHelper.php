...
namespace Remind\HeadlessSolr\ViewHelpers;
...
class ResultsViewHelper extends AbstractViewHelper
{
    ...
    public static function renderStatic(
        ...
        $paginationResult = $viewHelperInvoker->invoke(
            ...
            [
                PaginationViewHelper::ARGUMENT_PAGINATION => $pagination,
                PaginationViewHelper::ARGUMENT_CURRENT_PAGE => $currentPage,
                PaginationViewHelper::ARGUMENT_QUERY_PARAM => 'page',
            ],
            $renderingContext,
        );
